...
int cadastarAluno(Ficha aluno[], int nr_aluno) {
  ...
  do {
    ...
    if (aluno[nr_aluno].sexo == 'F' || aluno[nr_aluno].sexo == 'M' ||
        aluno[nr_aluno].sexo == 'f' || aluno[nr_aluno].sexo == 'm') {
      v = 1;
    } else {
    ...
    if (aluno[i].matricula == consulta) {
      ...
      if ((troca == 's') || (troca == 'S')) {
        ...
        do {
          ...
          if (aluno[i].sexo == 'F' || aluno[i].sexo == 'M' ||
              aluno[i].sexo == 'f' || aluno[i].sexo == 'm') {
            v = 1;
          } else {
            printf("\nSexo inválido. Digite 'M' ou 'F' maiúsculos.\n");
            //            getchar();
      ...
      printf("\nDeseja alterar a data de nascimento: %d/%d/%d? ",
      ...
      if ((troca == 's') || (troca == 'S')) {
        ...
        do {
          ...
          if (aluno[i].nascimento.dia > 31 || aluno[i].nascimento.dia <= 0) {
            printf("\nDia inválido.\n");
          } else
            v = 1;
        } while (!v);
        ...
        do {
          ...
          if (aluno[i].nascimento.mes > 12 || aluno[i].nascimento.mes <= 0) {
            printf("\nMês inválido.\n");
          } else
            v = 1;
        } while (!v);
...
int listarAluno(Ficha aluno[], int nr_aluno) {
  ...
  for (int i = 0; i < nr_aluno; i++) {
    if (aluno[i].matricula == consulta) {
      ...
      printf("Nome: %s\n", aluno[i].nome);
      printf("Sexo: %c\n", aluno[i].sexo);
      printf("Data de Nascimento: %d/%d/%d\n", aluno[i].nascimento.dia,
             aluno[i].nascimento.mes, aluno[i].nascimento.ano);
      printf("CPF.: ");
      for (j = 0; j < 3; j++)
        printf("%c", aluno[i].cpf[j]);
      printf(".");
